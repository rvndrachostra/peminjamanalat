...
@section('title', 'Tambah Alat Baru - Sport Hub')

@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Tambah Alat Baru</h1>
    <p class="text-gray-600 mt-2">Daftarkan Sport baru ke sistem</p>
</div>
...
<div class="bg-white rounded-lg shadow p-8 max-w-2xl">
    <form method="POST" action="{{ route('admin.equipments.store') }}" class="space-y-6">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700">Nama Sport</label>
