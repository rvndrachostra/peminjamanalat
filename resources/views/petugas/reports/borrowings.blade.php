...
@section('title', 'Laporan Peminjaman - Sport Hub')
...
<div class="mb-6">
    <div class="flex items-center justify-between">
        ...
        <button onclick="window.print()" class="bg-lime-600 text-white px-6 py-2 rounded-lg hover:bg-lime-700 transition font-medium">
            🖨️ Cetak Laporan
        </button>
    </div>
</div>
...
<div class="bg-white rounded-lg shadow p-8">
    <div class="mb-6 border-b pb-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-2">Sport Hub - Laporan Peminjaman</h2>
